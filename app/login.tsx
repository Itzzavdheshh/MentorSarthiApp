...
const styles = StyleSheet.create({
  ...
  header: { height: height * 0.38, justifyContent: 'flex-end', paddingBottom: 40 },
  ...
  headerSubtitle: { fontSize: 15, color: 'rgba(255,255,255,0.75)', marginTop: 4 },
  formCard: {
  ...
  formSubtitle: { fontSize: 14, color: Colors.textGray, marginTop: 4, marginBottom: 24 },
  ...
  registerText: { color: Colors.textGray, fontSize: 14 },
